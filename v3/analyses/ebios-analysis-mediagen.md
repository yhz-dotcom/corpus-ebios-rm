# Analyse EBIOS-RM IA — MediaGen

**Référence** : EBIOS-MEDIAGEN-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | MediaGen |
| **Entreprise** | 75 salariés, 12M€ CA |
| **Secteur** | Média |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Manipulation électorale |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 6 - Désinformation | Génération fake news |
...
### 4.1 Scénario Critique : Génération fake news

```mermaid
flowchart TB
    C1[Contexte<br/>Manipulation électorale] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route MediaGen — Conformité
...
1. **Génération fake news** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — MediaGen | Version 1.0 | Mars 2026*
