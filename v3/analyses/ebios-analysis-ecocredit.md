# Analyse EBIOS-RM IA — EcoCredit Score

**Référence** : EBIOS-ECOCREDIT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | EcoCredit Score |
| **Entreprise** | 200 salariés, 35M€ CA |
| **Secteur** | Finance |
| **Classification** | 🚫 Prohibited |
| **Incident** | Exclusion bancaire |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(d) | Scoring social |
...
### 4.1 Scénario Critique : Scoring social

```mermaid
flowchart TB
    C1[Contexte<br/>Exclusion bancaire] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route EcoCredit Score — Conformité
...
1. **Scoring social** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — EcoCredit Score | Version 1.0 | Mars 2026*
