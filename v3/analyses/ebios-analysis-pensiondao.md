# Analyse EBIOS-RM IA — PensionDAO

**Référence** : EBIOS-PENSIONDAO-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | PensionDAO |
| **Entreprise** | 35 salariés, 5M€ CA |
| **Secteur** | Finance |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Erreur calcul |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Finance | Gestion retraite |
...
### 4.1 Scénario Critique : Gestion retraite

```mermaid
flowchart TB
    C1[Contexte<br/>Erreur calcul] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route PensionDAO — Conformité
...
1. **Gestion retraite** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — PensionDAO | Version 1.0 | Mars 2026*
