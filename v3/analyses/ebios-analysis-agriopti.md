# Analyse EBIOS-RM IA — AgriOpti

**Référence** : EBIOS-AGRIOPTI-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AgriOpti |
| **Entreprise** | 55 salariés, 7M€ CA |
| **Secteur** | Agriculture |
| **Classification** | 🟡 Risque Limité |
| **Incident** | Épuisement sols |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Optimisation abusive |
...
### 4.1 Scénario Critique : Optimisation abusive

```mermaid
flowchart TB
    C1[Contexte<br/>Épuisement sols] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AgriOpti — Conformité
...
1. **Optimisation abusive** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — AgriOpti | Version 1.0 | Mars 2026*
