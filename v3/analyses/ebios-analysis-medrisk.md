# Analyse EBIOS-RM IA — MedRisk

**Référence** : EBIOS-MEDRISK-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Refus soins |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 1 - Santé | Évaluation risque patient |
...
### 4.1 Scénario Critique : Évaluation risque patient

```mermaid
flowchart TB
    C1[Contexte<br/>Refus soins] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route MedRisk — Conformité
...
1. **Évaluation risque patient** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — MedRisk | Version 1.0 | Mars 2026*
