...
**Référence** : EBIOS-AEGISCOUNTER-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Escalade cyber |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Attaque préemptive |
...
### 4.1 Scénario Critique : Attaque préemptive

```mermaid
flowchart TB
    C1[Contexte<br/>Escalade cyber] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
1. **Attaque préemptive** — Scénario 🔴 Critique
