# Analyse EBIOS-RM IA — EduMood

**Référence** : EBIOS-EDUMOOD-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | EduMood |
| **Entreprise** | 85 salariés, 10M€ CA |
| **Secteur** | Éducation |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Violation vie privée |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 3 - Surveillance | Surveillance émotionnelle |
...
### 4.1 Scénario Critique : Surveillance émotionnelle

```mermaid
flowchart TB
    C1[Contexte<br/>Violation vie privée] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route EduMood — Conformité
...
1. **Surveillance émotionnelle** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — EduMood | Version 1.0 | Mars 2026*
