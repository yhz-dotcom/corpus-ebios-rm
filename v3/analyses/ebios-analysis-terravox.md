# Analyse EBIOS-RM IA — TerraVox

**Référence** : EBIOS-TERRAVOX-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | TerraVox |
| **Entreprise** | 70 salariés, 12M€ CA |
| **Secteur** | Transport |
| **Classification** | 🟡 Risque Limité |
| **Incident** | Confusion commande |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Assistant vocal |
...
### 4.1 Scénario Critique : Assistant vocal

```mermaid
flowchart TB
    C1[Contexte<br/>Confusion commande] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route TerraVox — Conformité
...
1. **Assistant vocal** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — TerraVox | Version 1.0 | Mars 2026*
