# Analyse EBIOS-RM IA — ForceSelect

**Référence** : EBIOS-FORCESELECT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | ForceSelect |
| **Entreprise** | 80 salariés, 15M€ CA |
| **Secteur** | Défense |
| **Classification** | ⚪ Hors AI Act |
| **Incident** | Biais systémique |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 2(3) Militaire | Discrimination recrutement |
| **Décision automatique** | Partielle/Totale | Selon contexte |
| **Exception Art. 6(3)** | Non applicable | Impact significatif |
| **Classification finale** | ⚪ Hors AI Act | Obligations réglementaires |
...
### 4.1 Scénario Critique : Discrimination recrutement

```mermaid
flowchart TB
    C1[Contexte<br/>Biais systémique] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route ForceSelect — Conformité
...
1. **Discrimination recrutement** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — ForceSelect | Version 1.0 | Mars 2026*
