# Analyse EBIOS-RM IA — AutoHaul

**Référence** : EBIOS-AUTOHAUL-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AutoHaul |
| **Entreprise** | 180 salariés, 35M€ CA |
| **Secteur** | Transport |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Dilemme éthique |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Transport | Conduite autonome |
...
### 4.1 Scénario Critique : Conduite autonome

```mermaid
flowchart TB
    C1[Contexte<br/>Dilemme éthique] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AutoHaul — Conformité
...
1. **Conduite autonome** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — AutoHaul | Version 1.0 | Mars 2026*
