# Analyse EBIOS-RM IA — MilSelect

**Référence** : EBIOS-MILSELECT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | MilSelect |
| **Entreprise** | 180 salariés, 32M€ CA |
| **Secteur** | Défense |
| **Classification** | ⚪ Hors AI Act |
| **Incident** | Dual-use non déclaré |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 2(3) Militaire | Droit international |
...
### 4.1 Scénario Critique : Droit international

```mermaid
flowchart TB
    C1[Contexte<br/>Dual-use non déclaré] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route MilSelect — Conformité
...
1. **Droit international** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — MilSelect | Version 1.0 | Mars 2026*
