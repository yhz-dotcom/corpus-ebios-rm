# Analyse EBIOS-RM IA — SurveilEye

**Référence** : EBIOS-SURVEILEYE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | SurveilEye |
| **Entreprise** | 110 salariés, 18M€ CA |
| **Secteur** | Sécurité |
| **Classification** | 🚫 Prohibited |
| **Incident** | Surveillance masse |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(d) | Reconnaissance faciale temps réel |
...
### 4.1 Scénario Critique : Reconnaissance faciale temps réel

```mermaid
flowchart TB
    C1[Contexte<br/>Surveillance masse] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route SurveilEye — Conformité
...
1. **Reconnaissance faciale temps réel** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — SurveilEye | Version 1.0 | Mars 2026*
