# Analyse EBIOS-RM IA — AdPulse INCIDENT

**Référence** : EBIOS-ADPULSEINCIDENTS-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| Attribut | Valeur |
|:---------|:-------|
| **Nom** | AdPulse INCIDENT |
| **Entreprise** | 320 salariés, 58M€ CA |
| **Secteur** | Publicité |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Fuite données + manipulation |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Manipulation | Fuite 2M profils + discrimination |
| **Décision automatique** | Partielle/Totale | Selon contexte |
| **Exception Art. 6(3)** | Non applicable | Impact significatif |
| **Classification finale** | 🔴 Haut Risque | Obligations réglementaires |
...
### 4.1 Scénario Critique : Fuite 2M profils + discrimination

```mermaid
flowchart TB
    C1[Contexte<br/>Fuite données + manipulation] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
    P2 --> F1[Impact Final<br/>🔴 Critique]
...
| Évaluation | Valeur |
|:-----------|:-------|
| **Vraisemblance** | 🟡 2/4 — Élevée |
| **Impact technique** | 🔴 3/4 — Majeur |
| **Impact métier** | 🔴 3/4 — Critique |
| **Impact réglementaire** | 🔴 3/4 — Critique |
...
```mermaid
gantt
    title Feuille de Route AdPulse INCIDENT — Conformité
...
1. **Fuite 2M profils + discrimination** — Scénario 🔴 Critique
2. **Fuite données** — Scénario 🔴 Critique
3. **Sanction réglementaire** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — AdPulse INCIDENT | Version 1.0 | Mars 2026*
