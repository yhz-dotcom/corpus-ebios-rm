# Analyse EBIOS-RM IA — HELIOS-GRID

**Référence** : EBIOS-HELIOS-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Incendie sous-station |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Surcharge solaire |
...
### 4.1 Scénario Critique : Surcharge solaire

```mermaid
flowchart TB
    C1[Contexte<br/>Incendie sous-station] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route HELIOS-GRID — Conformité
...
1. **Surcharge solaire** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — HELIOS-GRID | Version 1.0 | Mars 2026*
