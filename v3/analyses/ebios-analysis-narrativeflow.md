# Analyse EBIOS-RM IA — NarrativeFlow

**Référence** : EBIOS-NARRATIVEFLOW-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | NarrativeFlow |
| **Entreprise** | 85 salariés, 14M€ CA |
| **Secteur** | RH |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Manipulation employés |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Manipulation | Profilage psychographique |
...
### 4.1 Scénario Critique : Profilage psychographique

```mermaid
flowchart TB
    C1[Contexte<br/>Manipulation employés] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route NarrativeFlow — Conformité
...
1. **Profilage psychographique** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — NarrativeFlow | Version 1.0 | Mars 2026*
