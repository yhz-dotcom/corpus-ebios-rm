# Analyse EBIOS-RM IA — TriageFlow

**Référence** : EBIOS-TRIAGEFLOW-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | TriageFlow |
| **Entreprise** | 160 salariés, 25M€ CA |
| **Secteur** | Santé |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Faux négatifs |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 1 - Santé | Triage automatisé |
...
### 4.1 Scénario Critique : Triage automatisé

```mermaid
flowchart TB
    C1[Contexte<br/>Faux négatifs] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route TriageFlow — Conformité
...
1. **Triage automatisé** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — TriageFlow | Version 1.0 | Mars 2026*
