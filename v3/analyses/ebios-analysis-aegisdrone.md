# Analyse EBIOS-RM IA — AegisDrone LAWS

**Référence** : EBIOS-AEGISDRONE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AegisDrone LAWS |
| **Entreprise** | 110 salariés, 95M€ CA |
| **Secteur** | Défense |
| **Classification** | ⚪ Hors AI Act |
| **Incident** | 3 civils tués test |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 2(3) Militaire | Crime de guerre |
...
### 4.1 Scénario Critique : Crime de guerre

```mermaid
flowchart TB
    C1[Contexte<br/>3 civils tués test] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AegisDrone LAWS — Conformité
...
1. **Crime de guerre** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — AegisDrone LAWS | Version 1.0 | Mars 2026*
