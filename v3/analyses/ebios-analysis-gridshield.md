# Analyse EBIOS-RM IA — GridShield

**Référence** : EBIOS-GRIDSHIELD-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | GridShield |
| **Entreprise** | 130 salariés, 28M€ CA |
| **Secteur** | Énergie |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Attaque cyber |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Protection réseau |
...
### 4.1 Scénario Critique : Protection réseau

```mermaid
flowchart TB
    C1[Contexte<br/>Attaque cyber] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route GridShield — Conformité
...
1. **Protection réseau** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — GridShield | Version 1.0 | Mars 2026*
