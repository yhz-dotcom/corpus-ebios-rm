# Analyse EBIOS-RM IA — PlayBalance

**Référence** : EBIOS-PLAYBALANCE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | PlayBalance |
| **Entreprise** | 110 salariés, 22M€ CA |
| **Secteur** | Éducation/Gaming |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Troubles comportementaux |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 3 - Manipulation | Addiction gamifiée |
...
### 4.1 Scénario Critique : Addiction gamifiée

```mermaid
flowchart TB
    C1[Contexte<br/>Troubles comportementaux] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route PlayBalance — Conformité
...
1. **Addiction gamifiée** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — PlayBalance | Version 1.0 | Mars 2026*
