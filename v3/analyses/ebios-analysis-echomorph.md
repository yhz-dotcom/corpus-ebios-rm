# Analyse EBIOS-RM IA — ECHO-MORPH

**Référence** : EBIOS-ECHOMORPH-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | ECHO-MORPH |
| **Entreprise** | 95 salariés, 45M€ CA |
| **Secteur** | Gaming |
| **Classification** | 🚫 Prohibited |
| **Incident** | Troubles dissociatifs |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(a) | Manipulation subliminale |
...
### 4.1 Scénario Critique : Manipulation subliminale

```mermaid
flowchart TB
    C1[Contexte<br/>Troubles dissociatifs] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route ECHO-MORPH — Conformité
...
1. **Manipulation subliminale** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — ECHO-MORPH | Version 1.0 | Mars 2026*
