# Analyse EBIOS-RM IA — GridSmart

**Référence** : EBIOS-GRIDSMART-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | GridSmart |
| **Entreprise** | 170 salariés, 38M€ CA |
| **Secteur** | Énergie |
...
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Smart grid autonome |
...
### 4.1 Scénario Critique : Smart grid autonome

```mermaid
flowchart TB
    C1[Contexte<br/>Cascading failure] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route GridSmart — Conformité
...
1. **Smart grid autonome** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — GridSmart | Version 1.0 | Mars 2026*
