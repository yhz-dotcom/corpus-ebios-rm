# Analyse EBIOS-RM IA — HELIOS-GRID INCIDENT

**Référence** : EBIOS-HELIOSINCIDENTS-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| Attribut | Valeur |
|:---------|:-------|
| **Nom** | HELIOS-GRID INCIDENT |
| **Entreprise** | 90 salariés, 18M€ CA |
| **Secteur** | Énergie |
...
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Blackout solaire |
...
### 4.1 Scénario Critique : Blackout solaire

```mermaid
flowchart TB
    C1[Contexte<br/>Panne réseau] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route HELIOS-GRID INCIDENT — Conformité
...
1. **Blackout solaire** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — HELIOS-GRID INCIDENT | Version 1.0 | Mars 2026*
