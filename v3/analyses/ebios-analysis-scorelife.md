# Analyse EBIOS-RM IA — ScoreLife

**Référence** : EBIOS-SCORELIFE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | ScoreLife |
| **Entreprise** | 180 salariés, 42M€ CA |
| **Secteur** | Finance |
| **Classification** | 🚫 Prohibited |
| **Incident** | Assurance refusée |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(c) | Scoring social santé |
...
### 4.1 Scénario Critique : Scoring social santé

```mermaid
flowchart TB
    C1[Contexte<br/>Assurance refusée] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route ScoreLife — Conformité
...
1. **Scoring social santé** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — ScoreLife | Version 1.0 | Mars 2026*
