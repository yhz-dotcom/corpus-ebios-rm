# Analyse EBIOS-RM IA — LearnAdapt

**Référence** : EBIOS-LEARNADAPT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | LearnAdapt |
| **Entreprise** | 95 salariés, 12M€ CA |
| **Secteur** | Éducation |
| **Classification** | 🟡 Risque Limité |
| **Incident** | Bulles filtrantes |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Personnalisation excessive |
...
### 4.1 Scénario Critique : Personnalisation excessive

```mermaid
flowchart TB
    C1[Contexte<br/>Bulles filtrantes] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route LearnAdapt — Conformité
...
1. **Personnalisation excessive** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — LearnAdapt | Version 1.0 | Mars 2026*
