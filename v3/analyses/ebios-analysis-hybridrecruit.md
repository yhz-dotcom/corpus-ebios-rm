# Analyse EBIOS-RM IA — HybridRecruit

**Référence** : EBIOS-HYBRIDRECRUIT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | HybridRecruit |
| **Entreprise** | 280 salariés, 45M€ CA |
| **Secteur** | Défense/Civil |
| **Classification** | 🚫 Prohibited |
| **Incident** | Même système civil/militaire |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 4 + Art. 5 | Cumul prohibited + exclu |
| **Décision automatique** | Partielle/Totale | Selon contexte |
| **Exception Art. 6(3)** | Non applicable | Impact significatif |
| **Classification finale** | 🚫 Prohibited | Obligations réglementaires |
...
### 4.1 Scénario Critique : Cumul prohibited + exclu

```mermaid
flowchart TB
    C1[Contexte<br/>Même système civil/militaire] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
    P2 --> F1[Impact Final<br/>⚫ Catastrophique]
...
flowchart TB
    ...
    T1 --> P1[Extraction]
    P1 --> P2[Exploitation]
    P2 --> F1[Impact<br/>⚫ Catastrophique]
...
```mermaid
gantt
    title Feuille de Route HybridRecruit — Conformité
...
1. **Cumul prohibited + exclu** — Scénario ⚫ Catastrophique
2. **Fuite données** — Scénario ⚫ Catastrophique
3. **Sanction réglementaire** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — HybridRecruit | Version 1.0 | Mars 2026*
