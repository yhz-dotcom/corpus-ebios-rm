# Analyse EBIOS-RM IA — Cognia

**Référence** : EBIOS-COGNIA-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | Cognia |
| **Entreprise** | 120 salariés, 15M€ CA |
| **Secteur** | Éducation |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Discrimination scolaire |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 3 - Éducation | Évaluation biaisée |
...
### 4.1 Scénario Critique : Évaluation biaisée

```mermaid
flowchart TB
    C1[Contexte<br/>Discrimination scolaire] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route Cognia — Conformité
...
1. **Évaluation biaisée** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — Cognia | Version 1.0 | Mars 2026*
