# Analyse EBIOS-RM IA — CLIMAT-ORACLE

**Référence** : EBIOS-CLIMATORACLE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Panique sociale |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Prédiction climatique |
...
### 4.1 Scénario Critique : Prédiction climatique

```mermaid
flowchart TB
    C1[Contexte<br/>Panique sociale] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route CLIMAT-ORACLE — Conformité
...
1. **Prédiction climatique** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — CLIMAT-ORACLE | Version 1.0 | Mars 2026*
