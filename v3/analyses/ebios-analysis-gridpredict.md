# Analyse EBIOS-RM IA — GridPredict

**Référence** : EBIOS-GRIDPREDICT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | GridPredict |
| **Entreprise** | 220 salariés, 50M€ CA |
| **Secteur** | Énergie |
...
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Prédiction demande |
...
### 4.1 Scénario Critique : Prédiction demande

```mermaid
flowchart TB
    C1[Contexte<br/>Délestage] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route GridPredict — Conformité
...
1. **Prédiction demande** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — GridPredict | Version 1.0 | Mars 2026*
