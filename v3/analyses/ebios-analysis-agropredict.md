# Analyse EBIOS-RM IA — AgroPredict

**Référence** : EBIOS-AGROPREDICT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AgroPredict |
| **Entreprise** | 50 salariés, 6M€ CA |
| **Secteur** | Agriculture |
| **Classification** | 🟡 Risque Limité |
| **Incident** | Erreur marché |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Prédiction rendement |
...
### 4.1 Scénario Critique : Prédiction rendement

```mermaid
flowchart TB
    C1[Contexte<br/>Erreur marché] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AgroPredict — Conformité
...
1. **Prédiction rendement** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — AgroPredict | Version 1.0 | Mars 2026*
