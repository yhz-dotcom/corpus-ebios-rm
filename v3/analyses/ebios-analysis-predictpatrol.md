# Analyse EBIOS-RM IA — PredictPatrol

**Référence** : EBIOS-PREDICTPATROL-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | PredictPatrol |
| **Entreprise** | 150 salariés, 28M€ CA |
| **Secteur** | Justice |
...
|:--------|:-----------|:--------------|
| **Annexe III** | Point 7 - Justice | Prédiction récidive |
...
### 4.1 Scénario Critique : Prédiction récidive

```mermaid
flowchart TB
    C1[Contexte<br/>Discrimination] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route PredictPatrol — Conformité
...
1. **Prédiction récidive** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — PredictPatrol | Version 1.0 | Mars 2026*
