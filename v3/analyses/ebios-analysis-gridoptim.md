# Analyse EBIOS-RM IA — GridOptim

**Référence** : EBIOS-GRIDOPTIM-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | GridOptim |
| **Entreprise** | 150 salariés, 35M€ CA |
| **Secteur** | Énergie |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Surcharge ligne |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Optimisation charge |
...
### 4.1 Scénario Critique : Optimisation charge

```mermaid
flowchart TB
    C1[Contexte<br/>Surcharge ligne] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route GridOptim — Conformité
...
1. **Optimisation charge** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — GridOptim | Version 1.0 | Mars 2026*
