# Analyse EBIOS-RM IA — PsychoLoot INCIDENT

**Référence** : EBIOS-PSYCHOLOOTINCIDENTS-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| Attribut | Valeur |
|:---------|:-------|
| **Nom** | PsychoLoot INCIDENT |
| **Entreprise** | 150 salariés, 180M€ CA |
| **Secteur** | Gaming |
| **Classification** | 🚫 Prohibited |
| **Incident** | Dépenses 800€+ |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(b) | Addiction prédation |
...
### 4.1 Scénario Critique : Addiction prédation

```mermaid
flowchart TB
    C1[Contexte<br/>Dépenses 800€+] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route PsychoLoot INCIDENT — Conformité
...
1. **Addiction prédation** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — PsychoLoot INCIDENT | Version 1.0 | Mars 2026*
