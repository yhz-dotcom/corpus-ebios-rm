# Analyse EBIOS-RM IA — NewsRank

**Référence** : EBIOS-NEWSRANK-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | NewsRank |
| **Entreprise** | 60 salariés, 9M€ CA |
| **Secteur** | Média |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Biais politique |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 6 - Curation | Censure algorithmique |
...
### 4.1 Scénario Critique : Censure algorithmique

```mermaid
flowchart TB
    C1[Contexte<br/>Biais politique] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route NewsRank — Conformité
...
1. **Censure algorithmique** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — NewsRank | Version 1.0 | Mars 2026*
