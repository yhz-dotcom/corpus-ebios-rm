# Analyse EBIOS-RM IA — CareCoord

**Référence** : EBIOS-CARECOORD-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | CareCoord |
| **Entreprise** | 140 salariés, 22M€ CA |
| **Secteur** | Santé |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Erreur médicamenteuse |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 1 - Santé | Coordination patients |
...
### 4.1 Scénario Critique : Coordination patients

```mermaid
flowchart TB
    C1[Contexte<br/>Erreur médicamenteuse] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route CareCoord — Conformité
...
1. **Coordination patients** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — CareCoord | Version 1.0 | Mars 2026*
