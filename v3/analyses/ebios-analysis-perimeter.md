# Analyse EBIOS-RM IA — Perimeter AI

**Référence** : EBIOS-PERIMETER-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | Perimeter AI |
| **Entreprise** | 95 salariés, 15M€ CA |
| **Secteur** | Sécurité |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Faux positifs |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Surveillance | Surveillance biométrique |
...
### 4.1 Scénario Critique : Surveillance biométrique

```mermaid
flowchart TB
    C1[Contexte<br/>Faux positifs] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route Perimeter AI — Conformité
...
1. **Surveillance biométrique** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — Perimeter AI | Version 1.0 | Mars 2026*
