# Analyse EBIOS-RM IA — AdPulse Dynamic

**Référence** : EBIOS-ADPULSE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Panique économique +340% conversions |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Manipulation | Manipulation émotionnelle |
...
### 4.1 Scénario Critique : Manipulation émotionnelle

```mermaid
flowchart TB
    C1[Contexte<br/>Panique économique +340% conversions] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AdPulse Dynamic — Conformité
...
1. **Manipulation émotionnelle** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — AdPulse Dynamic | Version 1.0 | Mars 2026*
