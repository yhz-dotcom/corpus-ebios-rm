# Analyse EBIOS-RM IA — VitaRisk

**Référence** : EBIOS-VITARISK-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | VitaRisk |
| **Entreprise** | 130 salariés, 20M€ CA |
| **Secteur** | Santé |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Décès évitable |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 1 - Santé | Évaluation risque vie |
...
### 4.1 Scénario Critique : Évaluation risque vie

```mermaid
flowchart TB
    C1[Contexte<br/>Décès évitable] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route VitaRisk — Conformité
...
1. **Évaluation risque vie** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — VitaRisk | Version 1.0 | Mars 2026*
