# Analyse EBIOS-RM IA — AgriScore

**Référence** : EBIOS-AGRISCORE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AgriScore |
| **Entreprise** | 70 salariés, 9M€ CA |
| **Secteur** | Agriculture |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Faillites forcées |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Crédit | Scoring agricole |
...
### 4.1 Scénario Critique : Scoring agricole

```mermaid
flowchart TB
    C1[Contexte<br/>Faillites forcées] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AgriScore — Conformité
...
1. **Scoring agricole** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — AgriScore | Version 1.0 | Mars 2026*
