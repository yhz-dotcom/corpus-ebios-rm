# Analyse EBIOS-RM IA — LifeGuard

**Référence** : EBIOS-LIFEGUARD-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | LifeGuard |
| **Entreprise** | 200 salariés, 45M€ CA |
| **Secteur** | Santé |
| **Classification** | 🚫 Prohibited |
| **Incident** | 400% prime assurance |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(b) | Surveillance comportementale |
...
### 4.1 Scénario Critique : Surveillance comportementale

```mermaid
flowchart TB
    C1[Contexte<br/>400% prime assurance] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route LifeGuard — Conformité
...
1. **Surveillance comportementale** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — LifeGuard | Version 1.0 | Mars 2026*
