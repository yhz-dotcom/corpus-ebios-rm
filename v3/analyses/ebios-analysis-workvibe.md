# Analyse EBIOS-RM IA — WorkVibe

**Référence** : EBIOS-WORKVIBE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | WorkVibe |
| **Entreprise** | 120 salariés, 20M€ CA |
| **Secteur** | RH |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Burnout massif |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Surveillance | Surveillance émotionnelle |
...
```mermaid
flowchart TB
    C1[Contexte<br/>Burnout massif] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route WorkVibe — Conformité
...
*Analyse EBIOS-RM IA — WorkVibe | Version 1.0 | Mars 2026*
