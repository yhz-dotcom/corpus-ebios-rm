# Analyse EBIOS-RM IA — SentinelAI

**Référence** : EBIOS-SENTINELAI-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | SentinelAI |
| **Entreprise** | 120 salariés, 25M€ CA |
| **Secteur** | Cybersécurité |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Faux positif masse |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Infrastructure | Autonomie décisionnelle |
...
### 4.1 Scénario Critique : Autonomie décisionnelle

```mermaid
flowchart TB
    C1[Contexte<br/>Faux positif masse] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route SentinelAI — Conformité
...
1. **Autonomie décisionnelle** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — SentinelAI | Version 1.0 | Mars 2026*
