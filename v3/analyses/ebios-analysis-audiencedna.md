# Analyse EBIOS-RM IA — AudienceDNA

**Référence** : EBIOS-AUDIENCEDNA-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AudienceDNA |
| **Entreprise** | 85 salariés, 12M€ CA |
| **Secteur** | Marketing |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Exploitation vulnérabilités |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 2 - Enfants | Ciblage émotionnel enfants |
...
### 4.1 Scénario Critique : Ciblage émotionnel enfants

```mermaid
flowchart TB
    C1[Contexte<br/>Exploitation vulnérabilités] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AudienceDNA — Conformité
...
1. **Ciblage émotionnel enfants** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — AudienceDNA | Version 1.0 | Mars 2026*
