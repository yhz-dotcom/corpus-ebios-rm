# Analyse EBIOS-RM IA — PsychoLoot

**Référence** : EBIOS-PSYCHOLOOT-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| **Incident** | Suicide adolescent |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Art. 5(1)(b) | Exploitation enfants |
...
### 4.1 Scénario Critique : Exploitation enfants

```mermaid
flowchart TB
    C1[Contexte<br/>Suicide adolescent] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route PsychoLoot — Conformité
...
1. **Exploitation enfants** — Scénario ⚫ Catastrophique
...
*Analyse EBIOS-RM IA — PsychoLoot | Version 1.0 | Mars 2026*
