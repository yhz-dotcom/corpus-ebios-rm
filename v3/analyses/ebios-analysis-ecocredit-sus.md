# Analyse EBIOS-RM IA — EcoCredit Sustainability

**Référence** : EBIOS-ECOCREDITSUS-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
| Attribut | Valeur |
|:---------|:-------|
| **Nom** | EcoCredit Sustainability |
| **Entreprise** | 250 salariés, 42M€ CA |
| **Secteur** | Finance |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Faillite chaîne |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 5 - Crédit | Score ESG entreprises |
...
### 4.1 Scénario Critique : Score ESG entreprises

```mermaid
flowchart TB
    C1[Contexte<br/>Faillite chaîne] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route EcoCredit Sustainability — Conformité
...
1. **Score ESG entreprises** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — EcoCredit Sustainability | Version 1.0 | Mars 2026*
