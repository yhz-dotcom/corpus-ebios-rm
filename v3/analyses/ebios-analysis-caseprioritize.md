# Analyse EBIOS-RM IA — CasePrioritize

**Référence** : EBIOS-CASEPRIORITIZE-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | CasePrioritize |
| **Entreprise** | 45 salariés, 6M€ CA |
| **Secteur** | Justice |
| **Classification** | 🔴 Haut Risque |
| **Incident** | Délai justice |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Point 7 - Justice | Priorisation dossiers |
...
### 4.1 Scénario Critique : Priorisation dossiers

```mermaid
flowchart TB
    C1[Contexte<br/>Délai justice] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route CasePrioritize — Conformité
...
1. **Priorisation dossiers** — Scénario 🔴 Critique
...
*Analyse EBIOS-RM IA — CasePrioritize | Version 1.0 | Mars 2026*
