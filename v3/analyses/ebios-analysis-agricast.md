# Analyse EBIOS-RM IA — AgriCast

**Référence** : EBIOS-AGRICAST-001 | **Date** : Mars 2026 | **Classification** : Confidentiel — Direction
...
|:---------|:-------|
| **Nom** | AgriCast |
| **Entreprise** | 65 salariés, 8M€ CA |
| **Secteur** | Agriculture |
| **Classification** | 🟡 Risque Limité |
| **Incident** | Perte récolte |

### 1.2 Classification AI Act

| Critère | Évaluation | Justification |
|:--------|:-----------|:--------------|
| **Annexe III** | Non Annexe III | Prédiction météo erronée |
...
### 4.1 Scénario Critique : Prédiction météo erronée

```mermaid
flowchart TB
    C1[Contexte<br/>Perte récolte] --> T1[Déclencheur]
    T1 --> P1[Propagation 1]
    P1 --> P2[Propagation 2]
...
```mermaid
gantt
    title Feuille de Route AgriCast — Conformité
...
1. **Prédiction météo erronée** — Scénario 🟡 Majeur
...
*Analyse EBIOS-RM IA — AgriCast | Version 1.0 | Mars 2026*
