...
graph LR
    ...
    classDef pillar fill:#00AEEF,stroke:#333,color:black,font-weight:bold

    %% Groupe Gauche : Communication avec largeur forcée
    subgraph Left [ ]
        direction TB
        Comm["<div style='width:110px; word-wrap:break-word;'>Communication and Consultation</div>"]:::pillar
    end
    ...
    %% Groupe Droite : Monitoring avec largeur forcée
    subgraph Right [ ]
        direction TB
        Mon["<div style='width:100px; word-wrap:break-word;'>Monitoring and Review</div>"]:::pillar
    end
