...
```mermaid
flowchart TB
    subgraph ISO31000["Cadre ISO 31000"]
        direction TB
        
        P1[🎯 Leadership & Engagement]
        P2[📋 Intégration
            dans la gouvernance]
        P3[🎨 Conception du cadre]
        P4[⚙️ Mise en œuvre
            & opération]
        P5[📊 Évaluation
            & amélioration]
    ...
    subgraph EBIOS["Application EBIOS RM"]
        direction TB
        
        E1[Atelier 1: Cadrage
            & Socle]
        E2[Atelier 2: Sources
            de risque]
        E3[Atelier 3: Scénarios
            de risque]
        E4[Atelier 4: Traitement
            du risque]
        E5[Atelier 5: Feuille
            de route]
    end
    ...
    style ISO31000 fill:#e3f2fd,stroke:#1565c0,stroke-width:2px
    style EBIOS fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px
```
